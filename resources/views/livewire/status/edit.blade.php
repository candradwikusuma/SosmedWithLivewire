                ...
                <form wire:submit.prevent="update">
                    <div class="p-4 bg-cool-gray-50 ">
                        <textarea placeholder="What's in your mind" wire:model="body"
                            class="form-textarea w-full bg-transparent  rounded-md  border-0  focus:shadow-none p-0 focus:ring-0  resize-none">asad</textarea>
                    ...
                    <div class="flex justify-end px-4 py-2 bg-cool-gray-100 border-t border-cool-gray-200">
                        {{-- <x-button.primary {{ isset($body) && !empty($body) ? '' : 'disabled' }}
                        value="{{ $body }}">Post
                        </x-button.primary> --}}
                        {{-- <button
